  ...
  'tour-packages': [
    {
      ...
      image: 'https://source.unsplash.com/1600x1000/?london,city,travel&sig=11',
      gallery: [
        'https://source.unsplash.com/900x600/?london,bridge,travel&sig=12',
        'https://source.unsplash.com/900x600/?museum,london,tour&sig=13',
        'https://source.unsplash.com/900x600/?thames,cruise,uk&sig=14',
      ],
      duration: '6 Nights / 7 Days',
      hotel: '4★ Central London Hotel',
      tours: 'City bus pass, Thames cruise, museum pass',
      price: '$2,450 per person',
      description: 'Perfect for first-time UK visitors who want flights, hotel, core city tours, and smooth logistics handled end-to-end.',
      idealFor: 'Couples, families, and small groups visiting London for leisure.',
      excludes: 'Visa fees, personal shopping, optional premium excursions.',
      popular: true,
      urgency: 'Only 6 slots left for next departure window',
    },
    {
      name: 'Dubai Luxury Escape',
      image: 'https://source.unsplash.com/1600x1000/?dubai,luxury,travel&sig=21',
      gallery: [
        'https://source.unsplash.com/900x600/?dubai,desert,safari&sig=22',
        'https://source.unsplash.com/900x600/?burj,khalifa,night&sig=23',
        'https://source.unsplash.com/900x600/?dubai,marina,cruise&sig=24',
      ],
      duration: '5 Nights / 6 Days',
      hotel: '5★ Downtown Dubai Hotel',
      tours: 'Desert safari, Marina cruise, Burj Khalifa ticket',
      price: '$2,100 per person',
      description: 'A premium Dubai starter package combining luxury stay, key experiences, and guided coordination from arrival to departure.',
      idealFor: 'Luxury leisure travelers, couples, and celebratory trips.',
      excludes: 'Visa fees (if applicable), personal purchases, optional activity upgrades.',
      urgency: 'High demand this month — lock in early',
    },
  ],
  'visa-assistance': [
    {
